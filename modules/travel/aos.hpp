...
//                setParams();
        ...
        ObjectCluster(const double min_range = 1.0, const double max_range = 100.0, const double min_vert_angle = -24.2, const double max_vert_angle = 24.2, const int line = 64) {
            setParams(min_range, max_range, min_vert_angle, max_vert_angle, line);
        }
        ...
        void setParams(const double min_range = 1.0, const double max_range = 100.0, const double min_vert_angle = -24.2, const double max_vert_angle = 24.2, const int line = 64) {
